...
<main class="page-container" style="max-width: 1000px; margin: 4rem auto; padding: 0 1.5rem;">
    ...
    <div class="glass-card" style="padding: 2.5rem; border-radius: 12px; background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.08); color: rgba(255,255,255,0.85); line-height: 1.8;">
        ...
        <h2 style="color: #fff; margin-bottom: 1rem; font-size: 1.4rem;">2. Freight & Delivery Charges</h2>
        <p style="margin-bottom: 1.5rem;">Delivery rates are calculated based on destination district. Standard Colombo delivery starts at <strong>LKR 2,500</strong>. Oversized items (bull bars, roll cages, leaf springs) may require specialized transport.</p>

        <h2 style="color: #fff; margin-bottom: 1rem; font-size: 1.4rem;">3. Delivery Timelines</h2>
        <p style="margin-bottom: 1.5rem;">In-stock items are dispatched within 24-48 hours. Western Province deliveries arrive within 1-2 business days; outstation deliveries arrive within 2-4 business days.</p>

        <h2 style="color: #fff; margin-bottom: 1rem; font-size: 1.4rem;">4. Tracking & Support</h2>
        <p>Once dispatched, our team will provide delivery updates via WhatsApp. For shipping inquiries, call <strong>+94 70 393 9459</strong>.</p>
    </div>
</main>
